...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="{{ !empty($userData->profile_image) ? url('upload/admin_images/' . $userData->profile_image) : url('backend/dist/img/user4-128x128.jpg') }}"
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('about.about_page') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>About Page</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('about.multiimage') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>About Multi Image</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('about.all.multiimage') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>All Multi Image</p>
                            </a>
                        </li>
