  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{ (!empty($userData->profile_image)?url('upload/admin_images/'.$userData->profile_image):url('backend/dist/img/user4-128x128.jpg'))}}" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
